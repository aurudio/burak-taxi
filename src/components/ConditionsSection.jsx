					...
					>
							...
							<div className='flex flex-col gap-1'>
								...
								<div className='flex justify-between'>
									<p className='min-2sm:text-sm text-xs font-normal'>
										За смену 100₽ и 1₽ с каждого заказа
									</p>
								</div>
							</div>
							<div className='flex flex-col gap-1'>
								...
								<div className='flex justify-between'>
									<p className='min-2sm:text-sm text-xs font-normal'>
										За смену 50₽ и 1₽ с каждого заказа
									</p>
								</div>
							</div>
						</div>
						<div className='w-3/4 lg:w-3/4 xl:w-11/12 text-right'>
							<h5 className='text-sm lg:text-xs 3sm::font-normal font-semibold'>
								...
								комиссия таксопарка составит 120 ₽, а для самозанятых,
								сотрудничающих через таксопарк, она будет всего 70 ₽. Комиссия
